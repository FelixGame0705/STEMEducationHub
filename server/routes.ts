...
import { 
  insertContactSchema, insertProgramSchema, insertStudentSchema, 
  insertNewsSchema, insertEventSchema, insertRecruitmentSchema 
} from "@shared/schema";
...
const uploadImageToCloudinary = async (file: Express.Multer.File, folder: string): Promise<string> => {
